...
public class SendMessagesTrafficLight : MonoBehaviour
{
    ...
    async void Start()
    {
        ...
        if (_clientvara != null && _clientvara.IsConnected)
        {
            ...
            destination.Create("0x59d593389507c73c89f2cf1a3478d36c55df13de4b8cf89295fb5cebc8db3f8d");

            // Convertir la cadena "Green" a un arreglo de bytes
            string message = "Green";
            byte[] messageBytes = Encoding.UTF8.GetBytes(message);

            // Convertir el arreglo de bytes a un arreglo de U8
            ...
            // Crear Input
            int index = 1;
            U8[] u8ArrayIndex = new U8[1];
            u8ArrayIndex[0] = new U8((byte)index);

            
            // Crear el payload usando BaseVec<U8>
            var payload = new BaseVec<U8>(u8ArrayIndex);
            var gas_limit = new U64(90000000000);
